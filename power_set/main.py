...
TODO:
- count entries in f2, f3

cProfile.runctx('f3(L1, L2)', {'f3': f3, 'L1': L1, 'L2': L2}, {})
"""
import collections
import random
import time
...
def main():
    ...
    for L1, L2, expected in test_cases:
        output_2, time_elapsed_2 = f2(L1, L2)
        output_3, time_elapsed_3 = f3(L1, L2)

        print(L1, L2)
        print([
            f'f2 {time_elapsed_2} ms', output_2, expected,
            f'f3 {time_elapsed_3} ms', output_3, expected,
        ])
        print('')
